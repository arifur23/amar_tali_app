...
import 'package:amar_tali_app/presentation/Reports/personal_expense_report.dart';
...
class _PersonalExpenseScreenState extends State<PersonalExpenseScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    var personalExpense = Provider.of<PersonalExpenseRepository>(context);
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          GestureDetector(
            onTap: (){
              Navigator.push(context, MaterialPageRoute(builder: (_) => const PersonalExpenseReportScreen()
              ));
            },
            child: Container(
              height: 40,
                                          ...
                                          children: <Widget>[
                                            ...
                                            GestureDetector(
                                              onTap: () async {
                                                ...
                                                await personalExpense.addPersonalExpense(detailsController.text, int.parse(amountController.text), selectedDate.toString()).then((value){
                                                });
                                                setState(() {
                                                  loading = false;
                                                });
